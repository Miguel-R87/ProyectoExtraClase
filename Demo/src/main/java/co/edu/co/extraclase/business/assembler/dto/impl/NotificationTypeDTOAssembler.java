...
public final class NotificationTypeDTOAssembler implements DTOAssembler<NotificationTypeDto, NotificationTypeDomain>{
    ...
    @Override
    public NotificationTypeDto toDTO(final NotificationTypeDomain domain) {
    ...
    @Override
    public NotificationTypeDomain toDomain(final NotificationTypeDto dto) {
    ...
    @Override
    public List<NotificationTypeDto> toDTO(final List<NotificationTypeDomain> domainList) {
